...
# @author Setting-Dawn
# @date 2025-Nov-21
# @file ExternalInterpret.py 
# @brief Externally interprets the 208 datapoints measured by the Soft Keyboard ESP32 using:
...
def setup(n_el,BL_corner,TR_corner):
    ...
    @param BL_corner : list
        bottom left corner coords of square
    @param TR_corner : list
...
def simEIT(mesh_obj, protocol_obj,anomalyList:list):
    ...
    @param protocol_obj : protocol_obj
        protocol the EIT analysis will use
    @param anomalyList : list
...
def send_flg(params: dict):
    ...
    ----------
    @param params:
        a dictionary of each arg,value pair to be sent to the ESP webpage
