...
\item 
<<<<<<< Updated upstream
IPAddress \mbox{\hyperlink{_e_i_twebhost_8cpp_a4bb2f6790489d53e1530b1f3bfdb043f}{local\+\_\+ip}} (192, 168, 5, 1)
\item 
IPAddress \mbox{\hyperlink{_e_i_twebhost_8cpp_a7f5e4435988c442ffce0ac2f1a53d866}{gateway}} (192, 168, 5, 1)
\item 
IPAddress \mbox{\hyperlink{_e_i_twebhost_8cpp_a89cf134ada28d8ce0192d9fcbc83614a}{subnet}} (255, 255, 255, 0)
\item 
...
void \mbox{\hyperlink{_e_i_twebhost_8cpp_a2db7e734a3678bd61b7b9556caf2d933}{setup\+\_\+wifi}} (void)
=======
...
\item 
<<<<<<< Updated upstream
const char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{_e_i_twebhost_8cpp_a587ba0cb07f02913598610049a3bbb79}{ssid}} = "{}Soft Keyboard"{}
\item 
const char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{_e_i_twebhost_8cpp_aa4a2ebcb494493f648ae1e6975672575}{password}} = "{}Access Code"{}
=======
...
<<<<<<< Updated upstream
\Hypertarget{_e_i_twebhost_8cpp_a7f5e4435988c442ffce0ac2f1a53d866}\index{EITwebhost.cpp@{EITwebhost.cpp}!gateway@{gateway}}
\index{gateway@{gateway}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{gateway()}{gateway()}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_a7f5e4435988c442ffce0ac2f1a53d866} 
IPAddress gateway (\begin{DoxyParamCaption}\item[{192}]{}{, }\item[{168}]{}{, }\item[{5}]{}{, }\item[{1}]{}{}\end{DoxyParamCaption})}
...
\end{DoxyParams}
<<<<<<< Updated upstream
\Hypertarget{_e_i_twebhost_8cpp_a4bb2f6790489d53e1530b1f3bfdb043f}\index{EITwebhost.cpp@{EITwebhost.cpp}!local\_ip@{local\_ip}}
\index{local\_ip@{local\_ip}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{local\_ip()}{local\_ip()}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_a4bb2f6790489d53e1530b1f3bfdb043f} 
IPAddress local\+\_\+ip (\begin{DoxyParamCaption}\item[{192}]{}{, }\item[{168}]{}{, }\item[{5}]{}{, }\item[{1}]{}{}\end{DoxyParamCaption})}
...
<<<<<<< Updated upstream
It\textquotesingle{}s kind of clumsy to have this object as a global, but that\textquotesingle{}s the way Arduino keeps things simple to program, without the user having to write custom classes or other intermediate-\/level structures. \Hypertarget{_e_i_twebhost_8cpp_a2db7e734a3678bd61b7b9556caf2d933}\index{EITwebhost.cpp@{EITwebhost.cpp}!setup\_wifi@{setup\_wifi}}
\index{setup\_wifi@{setup\_wifi}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{setup\_wifi()}{setup\_wifi()}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_a2db7e734a3678bd61b7b9556caf2d933} 
...
\Hypertarget{_e_i_twebhost_8cpp_a89cf134ada28d8ce0192d9fcbc83614a}\index{EITwebhost.cpp@{EITwebhost.cpp}!subnet@{subnet}}
\index{subnet@{subnet}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{subnet()}{subnet()}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_a89cf134ada28d8ce0192d9fcbc83614a} 
IPAddress subnet (\begin{DoxyParamCaption}\item[{255}]{}{, }\item[{255}]{}{, }\item[{255}]{}{, }\item[{0}]{}{}\end{DoxyParamCaption})}



\label{doc-var-members}
\Hypertarget{_e_i_twebhost_8cpp_doc-var-members}
\doxysubsection{Variable Documentation}
\Hypertarget{_e_i_twebhost_8cpp_aa4a2ebcb494493f648ae1e6975672575}\index{EITwebhost.cpp@{EITwebhost.cpp}!password@{password}}
\index{password@{password}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{password}{password}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_aa4a2ebcb494493f648ae1e6975672575} 
const char\texorpdfstring{$\ast$}{*} password = "{}Access Code"{}}

\Hypertarget{_e_i_twebhost_8cpp_a587ba0cb07f02913598610049a3bbb79}\index{EITwebhost.cpp@{EITwebhost.cpp}!ssid@{ssid}}
\index{ssid@{ssid}!EITwebhost.cpp@{EITwebhost.cpp}}
\doxysubsubsection{\texorpdfstring{ssid}{ssid}}
{\footnotesize\ttfamily \label{_e_i_twebhost_8cpp_a587ba0cb07f02913598610049a3bbb79} 
const char\texorpdfstring{$\ast$}{*} ssid = "{}Soft Keyboard"{}}
